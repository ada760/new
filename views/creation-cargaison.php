...
<input type="number" id="poidsMax" name="poidsMax" placeholder="Poids Max 50000 kg" required class="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-cyan-400 focus:outline-none text-sm">
<div id="weight-info" class="text-sm text-gray-400 mt-1 flex items-center">
</div>
</div>
<div>
